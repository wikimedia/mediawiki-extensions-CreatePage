...
/**
 * Aliases for the special pages of the Create Page extension.
 *
 * @since 0.1
 *
 * @file CreatePage.alias.php
 * @ingroup CreatePage
 *
 * @licence GNU GPL v3+
...
$specialPageAliases['diq'] = array(
	'CreatePageRedirect' => array( 'SerberdışêPeleVıraze' ),
);
...
$specialPageAliases['ja'] = array(
	'CreatePageRedirect' => array( 'ページリダイレクト作成', 'ページ転送作成' ),
);
...
$specialPageAliases['lrc'] = array(
	'CreatePageRedirect' => array( 'راس_کئردئن_بألگە_واگردونی' ),
);
...
$specialPageAliases['nds-nl'] = array(
	'CreatePageRedirect' => array( 'Zieddeurverwiezing_anmaken' ),
);
...
$specialPageAliases['zh-hant'] = array(
	'CreatePageRedirect' => array( '建立頁面重新導向' ),
);